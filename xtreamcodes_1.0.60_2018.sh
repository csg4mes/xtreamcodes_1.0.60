...
sudo wget https://raw.githubusercontent.com/tobi2021lol/xtreamcodes_1.0.60/master/youtube-dl -O /usr/local/bin/youtube-dl && chmod a+rx /usr/local/bin/youtube-dl
sudo updatedb
sudo apt-get update
